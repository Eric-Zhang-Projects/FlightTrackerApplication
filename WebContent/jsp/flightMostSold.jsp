...
<body>
	<nav class="navbar navbar-inverse">
		...
		<table class="table" style="width: 60%"  >
			<thead>
				<tr>
					<th scope="col">Flight That Sold the Most Tickets</th>
				</tr>
			</thead>
			<tbody>
			<% int[] greatest = (int[])request.getAttribute("greatest");%>
				<tr>
					<th scope="row">Flight Number: <%=greatest[0]%><p>
					Tickets Sold: <%=greatest[1]%><p>
					</th>
				</tr>
		</table>
