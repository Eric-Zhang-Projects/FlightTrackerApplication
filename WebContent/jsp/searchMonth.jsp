...
<body>
	...
	<form class="form-inline" action="${pageContext.servletContext.contextPath}/salesReport" method="POST">
		<h2>Search For Sales Report by Month</h2>
		<hr>
		<div class="form-group">
			Enter Month by Number:   <input type="text" placeholder="Jan. = 1, Feb. = 2, etc." name="month"required> 
